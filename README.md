...
| `OPENROUTER_MODELS` | Optional comma-separated OpenRouter models tried in order. `openrouter/free` routes to any currently available free model. | `openrouter/free` |
